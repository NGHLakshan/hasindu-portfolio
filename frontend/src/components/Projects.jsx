...
export const projects = [
    ...
    },
    {
        ...
        description: 'Developed a comprehensive Enterprise Resource Planning (ERP) system to streamline business operations and improve productivity.',
        features: [
            'Business Operations Streamlining',
            'Centralized Data Processing',
            'Modular Architecture',
        ],
        github: 'https://github.com/NGHLakshan/ERP-System',
        color: 'from-emerald-50 to-teal-50',
        accent: 'bg-teal-500',
        emoji: '📊',
    },
    {
        title: 'Python Forensic Data Carver',
        role: 'Developer',
        tools: ['Python', 'Flask', 'HTML'],
        description: 'A professional, standalone Windows forensic data carving tool. Recovers deleted files from raw drives using signature-based carving.',
        features: [
            'Raw Drive Analysis',
...
const ProjectCard = ({ project, i }) => {
    ...
    return (
        <motion.div
            ...
            className="group bg-white rounded-3xl overflow-hidden border border-slate-200 hover:border-slate-300 hover:shadow-2xl shadow-slate-100 transition-all duration-500"
        >
            {/* Project Banner */}
                ...
                <div className="flex justify-between items-start mb-3">
                    ...
                    <div className="flex items-center gap-2">
                        <a
                            ...
                            className="p-2 rounded-xl bg-slate-100 text-slate-500 hover:bg-slate-900 hover:text-white transition-all"
                        >
                            <Github size={18} />
                        </a>
                    </div>
